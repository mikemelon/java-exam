...
<div id="main">
    <div class="container" style="margin-top: 20px;">
        <form name="form1" method="post" action="judgesearchlist">
            ...
            <table class="mytable">
                ...
                <s:iterator value="questionList" status="st" var="item">
                    ...
                    <s:if test="#st.odd">#efefef</s:if>
                        ...
                        <s:if test=" #session['USER_INFO'].role==1">
                            <td>
                                <input name="judgeChecked" id="judgeChecked<s:property value="id"/>" type="checkbox"
                                       value="<s:property value="id"/>"/>
                                <label for="judgeChecked<s:property value="id"/>"><s:property
            ...
            <s:if test=" #session['USER_INFO'].role==1">
                <button class="layui-btn layui-btn-danger" onclick="form1.action='deletejudge';form1.submit();">删除中题目
                </button>
            </s:if>
        </form>
...
<script>
    ...
    function selectAllQuestion() {
        ...
        var allCheckBox = document.getElementsByName("judgeChecked");
